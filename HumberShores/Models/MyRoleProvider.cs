...
namespace HumberShores.Models
{
    public class MyRoleProvider : RoleProvider
    {
        ...
        /// <returns></returns>
        public override string[] GetRolesForUser(string user_username)
        {
            MattDatabaseEntities db = new MattDatabaseEntities();

            //Site_Users is tied to the Site_Roles and the Role_Name column contains the name of the role.
            string role = db.site_users.Where(u => u.user_username == user_username).FirstOrDefault().site_roles.role_name;
